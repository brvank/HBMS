...
public class ExternalAppStorage {
    private Context context;

    public ExternalAppStorage(Context context){
        this.context = context;
    }

    public File getFile(String fileName){
        boolean status = true;
        File file = new File(context.getExternalFilesDir(AppConstant.APP_EXT_STORAGE), fileName);
        try{
            if(!file.exists()){
